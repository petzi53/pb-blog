...
{{< figure src="images/2019-C4LPT-categorization-min.png?classes=border, shadow" class="floatright" alt="Categories of tools by Jane Hart" >}}
...
{{< figure src="images/2019-C4LPT-HE-categorization-min.png?classes=border, shadow" width="75%"
...
{{< figure src="images/learning-modes-min.png?classes=border, shadow" class="floatright"
...
{{< figure src="images/survey-TT4L-min.png?classes=border, shadow" class="floatright"
